...
public class UserController {
  ...
  @GetMapping("/list")
  public ResponseEntity<HttpResponse> getPageAllCustomers(@AuthenticationPrincipal UserDTO user,
      @RequestParam Optional<Integer> page, @RequestParam Optional<Integer> size) {
    return ResponseEntity.ok(HttpResponse.builder()
        .developerMessage("customers retrieved")
        .message("customers retrieved")
        .data(Map.of("user", user, "page", customerService.getAllPageCustomers(page.orElse(0),size.orElse(10))))
